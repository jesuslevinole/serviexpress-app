  ...
  relatedViews: [
    {
      ...
      foreignKey: 'idTruck',
      emptyMessage: 'This truck has not been in the shop',
      fields: [
        { key: 'creationDate', label: 'Opened', type: 'date' },
        { key: 'idShopName', label: 'Shop', type: 'ref', refCollection: COLLECTIONS.shopNames },
        { key: 'diagnostic', label: 'Diagnostic', type: 'text' },
    ...
    },
    {
      ...
      foreignKey: 'idTruck',
      emptyMessage: 'This truck has no Fleet record yet',
      fields: [
        { key: 'route', label: 'Route', type: 'text' },
        { key: 'idDriver', label: 'Driver', type: 'ref', refCollection: COLLECTIONS.drivers },
        { key: 'idStation', label: 'Station', type: 'ref', refCollection: COLLECTIONS.stations },
        { key: 'sNumber', label: '# Serial scanner', type: 'text' },
        { key: 'idUsers', label: 'By', type: 'ref', refCollection: COLLECTIONS.users },
      ],
    },
    {
